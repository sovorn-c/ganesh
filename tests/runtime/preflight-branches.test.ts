...
import {
  ...
  checkRequiredTools,
  readNpmVersion
} from "../../src/runtime/preflight-checks.js";
import {
  hasProjectDependencies,
  readPackageJson,
  readProjectConfig
} from "../../src/runtime/preflight-config.js";
...
test("clean-install reports both successful and unavailable npm paths", () => {
  ...
  try {
    ...
    mkdirSync(join(fixtureRoot, "tests/runtime"), { recursive: true });
    cpSync(join(process.cwd(), "tests/runtime/baseline.test.ts"), join(fixtureRoot, "tests/runtime/baseline.test.ts"));
