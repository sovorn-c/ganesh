...
test("e02s02 branch snapshot history and isolation", () => {
...
test("e02s02 concurrent stale writer and duplicate command protection", () => {
  const fixture = projectFixture();
...
test("e02s02 promotion isolates candidates and records dependency impact", () => {
  const fixture = projectFixture();
  try {
...
test("e02s02 shared source correction preserves branch snapshots", () => {
  const fixture = projectFixture();
  try {
