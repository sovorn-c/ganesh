...
test("e04s04 records scholarly disagreement and a durable reasoned owner override", () => {
...
test("e04s04 non-waivable privacy gates block unknown authorization and wrong candidates", () => {
  const fixture = projectFixture();
  try {
    const candidate = artifact(fixture.handle, "hypothesis", "v1", "hypothesis");
...
test("e04s04 passes documented gates and bounds finite disagreement regression to one revision", () => {
  const fixture = projectFixture();
  try {
