...
test("e04s01 publishes exact packets, blocks forged authority, and redacts regression data", () => {
...
test("e04s01 rejects stale and duplicate owner actions without partial transaction state", () => {
  const fixture = projectFixture();
  try {
