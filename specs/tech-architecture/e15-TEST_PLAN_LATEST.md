...
| SC-e15s01-P0-02 | Forged, wrong-owner, worker and missing-capability callers cannot export a project packet. | P0 | Adversarial integration | `tests/integration/portability-authority.test.ts`, `src/portability/export-store.ts` |
...
| SC-e15s04-P1-04 | Workers and forged owners cannot delete; permitted non-sensitive decision history rows remain after deletion. | P1 | Adversarial integration | `tests/integration/portability-authority.test.ts`, `src/decisions/commitment-store.ts` |
