...
import { addImpact, dependentVersions, listImpacts } from "./dependency-store.js";
...
import { ProjectStoreError, type BranchReference, type ImpactRecord, type ProjectHandle } from "./project-types.js";
import { transaction } from "./schema.js";
import { assertIdentifier, newId } from "./storage-utils.js";
import { id, json, now, requireOwner, setEqual, text, uniqueIds } from "./e04-utils.js";
import { payloadHash, historyByCommand, insertHistory } from "./history-store.js";
